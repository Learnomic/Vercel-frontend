...
// import { FaSpinner, FaRegCircle, FaCheckCircle, FaClock } from 'react-icons/fa';
...
//               <div className="flex justify-between items-center">
//                 <h3 className="text-lg font-medium text-gray-800">{selectedVideo.title}</h3>
  ...
  return (
    <div className="scrollbar-hide flex flex-col md:flex-row h-screen bg-gray-100 overflow-hidden">
      ...
      <div className="scrollbar-hide w-full md:w-2/3 lg:w-3/4 overflow-y-auto h-[calc(100vh-112px)] md:h-screen pt-2 px-2 md:p-4">
        ...
        {/* Fixed floating button on mobile to show video list */}
        {/* <button
          onClick={toggleSidebar}
          className="fixed bottom-4 right-4 md:hidden z-30 w-12 h-12 rounded-full bg-indigo-600 text-white shadow-lg flex items-center justify-center"
        >
          <FaList />
        </button> */}
      </div>
